...
* One way to increase the base is by capturing the phrases as part of user keystrokes and compling them to increase the n gram base. While the data from the keystrokes may already exist, for these phrases, only the frequency would increase. while this is not built into my applciation, it would definitely be a consideration for future enhancements.
